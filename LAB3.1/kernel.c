...
{	
	int seg = (p+1)*0x1000;
	copyImage(running->uss, seg, 32*1024);
	running->uss = seg;
	put_word(seg, running->uss, running->usp+2*10);
	put_word(seg, running->uss, running->usp+2*2);
	put_word(seg, running->uss, running->usp);
	put_word(0x0200, running->uss, running->usp+2*1);
      /*put_word(seg, seg, -12*2);
      put_word(p->uss, p->uss, -11*2);
